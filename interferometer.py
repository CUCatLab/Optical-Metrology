...
def intensity(theta1,theta3,theta4,theta2min,theta2max, l= np.array([1, 0]), theta1error = 0.0, theta3error = 0.0, aeff = 0.1, beff = .1, ceff = .1, deff = 0.0, delta = 5):
    ...
    theta2s = np.arange(theta2min,theta2max,delta) # making an array of all the different rotation angles of polarizer between set max and min angles
